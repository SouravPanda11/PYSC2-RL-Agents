...
# Represents an action where the agent performs no operation during a game tick. This can be useful for situations
# where delaying action or waiting is strategically advantageous.
...
# SCVs are used for gathering resources and constructing buildings.
