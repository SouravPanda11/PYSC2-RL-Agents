...
class SparseAgent(base_agent.BaseAgent):
    ...
    def handle_first_step(self, obs, current_state):
    ...
    def handle_second_step(self, obs):
    ...
    def handle_third_step(self, obs):
        smart_action, x, y = self.split_action(self.previous_action)
        unit_type = obs.observation['feature_screen'][_UNIT_TYPE]
    ...
    def step(self, obs):
        ...
        if self.move_number == 0:
            self.move_number += 1
            return self.handle_first_step(obs, current_state)

        elif self.move_number == 1:
            self.move_number += 1
            return self.handle_second_step(obs)

        elif self.move_number == 2:
            self.move_number = 0
            return self.handle_third_step(obs)
